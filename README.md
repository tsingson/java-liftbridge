...
**fork from [https://github.com/caio/grpc-java-gradle-hello-world](https://github.com/caio/grpc-java-gradle-hello-world) , add goland  server side  / swift client side  [WIP]**
